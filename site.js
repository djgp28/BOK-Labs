...
(function () {
  ...
  var ES = {
    ...
    'foot.tag': 'Haciendo que los pequeños negocios se sientan grandes.',
    ...
    'hero.r': 'Podría funcionar con tu sistema.',
    'hero.sub': 'BOK Labs construye los flujos de trabajo, automatizaciones y sistemas con IA ajustados a las necesidades de tu negocio para acelerar el crecimiento.',
    'hero.status': 'en marcha · nada pendiente de ti',
    't1.l': 'El precio está en un correo con alguien.',
